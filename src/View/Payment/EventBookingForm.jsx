...
const EventBookingForm = ({ onSubmit, onCancel, eventDetails }) => {
  ...
  const handlePayment = async (formData, eventDetails) => {
    try {
      ...
      // Store event details with original ID
      localStorage.setItem('paymentDetails', JSON.stringify({
        _id: eventDetails._id, // Store the original event ID
      ...
      const packageDetails = {
        _id: eventDetails._id, // Keep the original event ID
        title: eventDetails.name,
      ...
      const paymentRequestData = {
        itemId: eventDetails._id, // Use the original event ID

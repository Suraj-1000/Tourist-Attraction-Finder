    ...
    <>
      ...
      <div className="main-container58">
        <div className="event-detail-container58">
          ...
          <div className="reviews-section58">
            <h2 className="section-title58">Reviews & Ratings</h2>
            <div className="rating-summary58">
              <div className="average-rating58">
                <span className="rating-number58">{event.averageRating?.toFixed(1) || '0.0'}</span>
                <div className="stars-container58">
                  {[...Array(5)].map((_, index) => (
                    <FaStar
                      key={index}
                ...
                <span className="total-reviews58">{event.totalReviews || 0} reviews</span>
              </div>
            </div>
            
            <div className="reviews-list58">
              {event.reviews && event.reviews.length > 0 ? (
                event.reviews.map((review, index) => (
                  <div key={index} className="review-card58">
                    <div className="review-card-header58">
                      <div className="reviewer-info58">
                        <h3>{renderUserInfo(review)}</h3>
                        <span className="review-date58">{new Date(review.createdAt).toLocaleDateString('en-US', {
                          year: 'numeric',
                          month: 'long',
                          day: 'numeric'
                        })}</span>
                      </div>
                      <div className="review-rating58">
                        {[...Array(5)].map((_, i) => (
                          <FaStar
                            key={i}
                    ...
                    <p className="review-text58">{review.review}</p>
                    {review.bookingDetails && (
                      <div className="review-details58">
                ...
                <p className="no-reviews58">No reviews yet. Be the first to review!</p>
              )}
            </div>
          </div>
